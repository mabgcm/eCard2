...
const EditCard = () => {
    ...
    const { fullname, company, title, workphone, homephone, mobilephone, workaddress, homeaddress, email, website, dob, facebook, twitter, instagram, github, imgUrl, photo } = form;
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex flex-column align-items-center text-center">
                                        < img src={imgUrl ? imgUrl : user?.photoURL} alt="UserPhoto" className="rounded-circle" width="150" />
                                        <div class="mt-3">
                                            <h4>{fullname}</h4>
